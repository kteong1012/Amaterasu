    ...
    public class UXImage : Image, ILocalization
    {
        ...
        private void SetInstanceMaterial()
        {
            material = new Material(s_UXImageMaterial
                                    ? s_UXImageMaterial
                                    : s_UXImageMaterial = new Material(ResourceManager.Load<Shader>("Shader/UXImage")) { name = "UXImage" });
        ...
        public void ChangeLanguage(LocalizationHelper.LanguageType language)
        {
            ...
            {
                base.sprite = ResourceManager.Load<Sprite>(UXGUIConfig.LocalizationFolder + suffix[languageIndex] + "/" + origin_name + "_" + suffix[languageIndex]);
                if (sprite == null)
                {
