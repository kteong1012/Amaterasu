...
public sealed class AoeEffect :  Result.VisualResult 
{
    public AoeEffect()
    {
            prefabRoute = null;
    ...
    private const string TYPE_STR = "AoeEffect";
    ...
    public static void RenderAoeEffect(AoeEffect obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static AoeEffect LoadJsonAoeEffect(SimpleJSON.JSONNode _json)
    {
        AoeEffect obj = new Result.AoeEffect();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonAoeEffect(AoeEffect _obj, SimpleJSON.JSONNode _json)
    {
