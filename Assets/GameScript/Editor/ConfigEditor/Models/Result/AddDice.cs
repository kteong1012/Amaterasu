...
public sealed class AddDice :  Result.DataResult 
{
    public AddDice()
    {
    ...
    private const string TYPE_STR = "AddDice";
    ...
    public static void RenderAddDice(AddDice obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static AddDice LoadJsonAddDice(SimpleJSON.JSONNode _json)
    {
        AddDice obj = new Result.AddDice();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonAddDice(AddDice _obj, SimpleJSON.JSONNode _json)
    {
