...
public sealed class FixedRecover :  Result.DataResult 
{
    public FixedRecover()
    {
    ...
    private const string TYPE_STR = "FixedRecover";
    ...
    public override void LoadJson(SimpleJSON.JSONObject _json)
    {
        ...
        { 
            var _fieldJson = _json["recover_value"];
            if (_fieldJson != null)
            {
                if(!_fieldJson.IsNumber) { throw new SerializationException(); }  recoverValue = _fieldJson;
            }
            else
            {
                recoverValue = 0;
    ...
    public override void SaveJson(SimpleJSON.JSONObject _json)
    {
        ...
        {
            _json["recover_value"] = new JSONNumber(recoverValue);
        }
    }

    private static GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);

    public static void RenderFixedRecover(FixedRecover obj)
    {
        obj.Render();
    }
...
if (ConfigEditorSettings.showComment)
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("恢复值", "recover_value"), GUILayout.Width(100));
}
else
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("recover_value", "恢复值"), GUILayout.Width(100));
}
this.recoverValue = UnityEditor.EditorGUILayout.IntField(this.recoverValue, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}    }
    public static FixedRecover LoadJsonFixedRecover(SimpleJSON.JSONNode _json)
    {
        FixedRecover obj = new Result.FixedRecover();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonFixedRecover(FixedRecover _obj, SimpleJSON.JSONNode _json)
    {
