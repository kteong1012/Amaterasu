...
public sealed class FixedDmg :  Result.DataResult 
{
    public FixedDmg()
    {
    ...
    private const string TYPE_STR = "FixedDmg";
    ...
    public static void RenderFixedDmg(FixedDmg obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static FixedDmg LoadJsonFixedDmg(SimpleJSON.JSONNode _json)
    {
        FixedDmg obj = new Result.FixedDmg();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonFixedDmg(FixedDmg _obj, SimpleJSON.JSONNode _json)
    {
