...
public sealed class CharaAttrGainExtraMana :  Result.DataResult 
{
    public CharaAttrGainExtraMana()
    {
    ...
    private const string TYPE_STR = "CharaAttrGainExtraMana";
    ...
    public override void LoadJson(SimpleJSON.JSONObject _json)
    {
        ...
        { 
            var _fieldJson = _json["mana_mul"];
            if (_fieldJson != null)
            {
                if(!_fieldJson.IsNumber) { throw new SerializationException(); }  manaMul = _fieldJson;
            }
            else
            {
                manaMul = 0;
    ...
    public override void SaveJson(SimpleJSON.JSONObject _json)
    {
        ...
        {
            _json["mana_mul"] = new JSONNumber(manaMul);
        }
    }

    private static GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);

    public static void RenderCharaAttrGainExtraMana(CharaAttrGainExtraMana obj)
    {
        obj.Render();
    }
...
if (ConfigEditorSettings.showComment)
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("行动点倍率", "mana_mul"), GUILayout.Width(100));
}
else
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("mana_mul", "行动点倍率"), GUILayout.Width(100));
}
this.manaMul = UnityEditor.EditorGUILayout.DoubleField(this.manaMul, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}    }
    public static CharaAttrGainExtraMana LoadJsonCharaAttrGainExtraMana(SimpleJSON.JSONNode _json)
    {
        CharaAttrGainExtraMana obj = new Result.CharaAttrGainExtraMana();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonCharaAttrGainExtraMana(CharaAttrGainExtraMana _obj, SimpleJSON.JSONNode _json)
    {
