...
public sealed class BuffStackDmg :  Result.DataResult 
{
    public BuffStackDmg()
    {
    ...
    private const string TYPE_STR = "BuffStackDmg";
    ...
    public static void RenderBuffStackDmg(BuffStackDmg obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static BuffStackDmg LoadJsonBuffStackDmg(SimpleJSON.JSONNode _json)
    {
        BuffStackDmg obj = new Result.BuffStackDmg();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonBuffStackDmg(BuffStackDmg _obj, SimpleJSON.JSONNode _json)
    {
