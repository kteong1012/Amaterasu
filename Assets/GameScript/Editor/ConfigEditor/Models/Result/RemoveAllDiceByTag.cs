...
public sealed class RemoveAllDiceByTag :  Result.DataResult 
{
    public RemoveAllDiceByTag()
    {
    ...
    private const string TYPE_STR = "RemoveAllDiceByTag";
    ...
    public static void RenderRemoveAllDiceByTag(RemoveAllDiceByTag obj)
    {
        obj.Render();
    }
...
if (ConfigEditorSettings.showComment)
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("骰子池类型", "dice_pool_type"), GUILayout.Width(100));
}
else
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("dice_pool_type", "骰子池类型"), GUILayout.Width(100));
}
{
    if (ConfigEditorSettings.showComment)
    {
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static RemoveAllDiceByTag LoadJsonRemoveAllDiceByTag(SimpleJSON.JSONNode _json)
    {
        RemoveAllDiceByTag obj = new Result.RemoveAllDiceByTag();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonRemoveAllDiceByTag(RemoveAllDiceByTag _obj, SimpleJSON.JSONNode _json)
    {
