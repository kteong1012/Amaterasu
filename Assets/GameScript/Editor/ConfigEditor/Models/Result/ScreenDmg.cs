...
public sealed class ScreenDmg :  Result.VisualResult 
{
    public ScreenDmg()
    {
            prefabRoute = null;
    ...
    private const string TYPE_STR = "ScreenDmg";
    ...
    public static void RenderScreenDmg(ScreenDmg obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static ScreenDmg LoadJsonScreenDmg(SimpleJSON.JSONNode _json)
    {
        ScreenDmg obj = new Result.ScreenDmg();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonScreenDmg(ScreenDmg _obj, SimpleJSON.JSONNode _json)
    {
