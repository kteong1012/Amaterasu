...
public sealed class AoeDmg :  Result.VisualResult 
{
    public AoeDmg()
    {
            prefabRoute = null;
    ...
    private const string TYPE_STR = "AoeDmg";
    ...
    public static void RenderAoeDmg(AoeDmg obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static AoeDmg LoadJsonAoeDmg(SimpleJSON.JSONNode _json)
    {
        AoeDmg obj = new Result.AoeDmg();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonAoeDmg(AoeDmg _obj, SimpleJSON.JSONNode _json)
    {
