...
public sealed class ScreenEffect :  Result.VisualResult 
{
    public ScreenEffect()
    {
            prefabRoute = null;
    ...
    private const string TYPE_STR = "ScreenEffect";
    ...
    public static void RenderScreenEffect(ScreenEffect obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static ScreenEffect LoadJsonScreenEffect(SimpleJSON.JSONNode _json)
    {
        ScreenEffect obj = new Result.ScreenEffect();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonScreenEffect(ScreenEffect _obj, SimpleJSON.JSONNode _json)
    {
