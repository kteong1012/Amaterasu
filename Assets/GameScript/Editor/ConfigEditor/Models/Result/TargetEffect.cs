...
public sealed class TargetEffect :  Result.VisualResult 
{
    public TargetEffect()
    {
            prefabRoute = null;
    ...
    private const string TYPE_STR = "TargetEffect";
    ...
    public static void RenderTargetEffect(TargetEffect obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static TargetEffect LoadJsonTargetEffect(SimpleJSON.JSONNode _json)
    {
        TargetEffect obj = new Result.TargetEffect();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonTargetEffect(TargetEffect _obj, SimpleJSON.JSONNode _json)
    {
