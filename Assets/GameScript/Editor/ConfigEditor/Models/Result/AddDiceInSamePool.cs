...
public sealed class AddDiceInSamePool :  Result.DataResult 
{
    public AddDiceInSamePool()
    {
            targetType = GameEditor.ConfigEditor.Model.Result.TargetType.Caster;
    }
    public override string GetTypeStr() => TYPE_STR;
    private const string TYPE_STR = "AddDiceInSamePool";
    ...
    public static void RenderAddDiceInSamePool(AddDiceInSamePool obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static AddDiceInSamePool LoadJsonAddDiceInSamePool(SimpleJSON.JSONNode _json)
    {
        AddDiceInSamePool obj = new Result.AddDiceInSamePool();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonAddDiceInSamePool(AddDiceInSamePool _obj, SimpleJSON.JSONNode _json)
    {
