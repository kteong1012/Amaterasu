...
public sealed class CharaAttrDmg :  Result.DataResult 
{
    public CharaAttrDmg()
    {
    ...
    private const string TYPE_STR = "CharaAttrDmg";
    ...
    public static void RenderCharaAttrDmg(CharaAttrDmg obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static CharaAttrDmg LoadJsonCharaAttrDmg(SimpleJSON.JSONNode _json)
    {
        CharaAttrDmg obj = new Result.CharaAttrDmg();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonCharaAttrDmg(CharaAttrDmg _obj, SimpleJSON.JSONNode _json)
    {
