...
public sealed class AddBuff :  Result.DataResult 
{
    public AddBuff()
    {
    ...
    private const string TYPE_STR = "AddBuff";
    ...
    public static void RenderAddBuff(AddBuff obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static AddBuff LoadJsonAddBuff(SimpleJSON.JSONNode _json)
    {
        AddBuff obj = new Result.AddBuff();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonAddBuff(AddBuff _obj, SimpleJSON.JSONNode _json)
    {
