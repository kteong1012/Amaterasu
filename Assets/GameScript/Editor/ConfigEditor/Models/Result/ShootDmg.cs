...
public sealed class ShootDmg :  Result.VisualResult 
{
    public ShootDmg()
    {
            prefabRoute = null;
    ...
    private const string TYPE_STR = "ShootDmg";
    ...
    public static void RenderShootDmg(ShootDmg obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static ShootDmg LoadJsonShootDmg(SimpleJSON.JSONNode _json)
    {
        ShootDmg obj = new Result.ShootDmg();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonShootDmg(ShootDmg _obj, SimpleJSON.JSONNode _json)
    {
