...
public sealed class TargetHeal :  Result.VisualResult 
{
    public TargetHeal()
    {
            prefabRoute = null;
    ...
    private const string TYPE_STR = "TargetHeal";
    ...
    public static void RenderTargetHeal(TargetHeal obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static TargetHeal LoadJsonTargetHeal(SimpleJSON.JSONNode _json)
    {
        TargetHeal obj = new Result.TargetHeal();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonTargetHeal(TargetHeal _obj, SimpleJSON.JSONNode _json)
    {
