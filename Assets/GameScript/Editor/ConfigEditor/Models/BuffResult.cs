...
public sealed class BuffResult :  BuffHandler 
{
    public BuffResult()
    {
    ...
    private const string TYPE_STR = "BuffResult";
    ...
    public static void RenderBuffResult(BuffResult obj)
    {
        obj.Render();
    }
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static BuffResult LoadJsonBuffResult(SimpleJSON.JSONNode _json)
    {
        BuffResult obj = new BuffResult();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonBuffResult(BuffResult _obj, SimpleJSON.JSONNode _json)
    {
