...
{
    public partial class BuffDiceCategory : IConfigEditorTable
    {
        private List<GameEditor.ConfigEditor.Model.BuffDiceConfig> _datas = new List<GameEditor.ConfigEditor.Model.BuffDiceConfig>();
        ...
        private string _name => "BuffDiceCategory";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public BuffDiceCategory(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = GameEditor.ConfigEditor.Model.BuffDiceConfig.LoadJsonBuffDiceConfig(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = GameEditor.ConfigEditor.Model.BuffDiceConfig.LoadJsonBuffDiceConfig(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                GameEditor.ConfigEditor.Model.BuffDiceConfig.SaveJsonBuffDiceConfig(data, json);
                jsonArray.Add(json);
            }
            return jsonArray.ToString(4);
        }

        private string GetDataJson(GameEditor.ConfigEditor.Model.BuffDiceConfig data)
        {
            var json = new JSONObject();
            GameEditor.ConfigEditor.Model.BuffDiceConfig.SaveJsonBuffDiceConfig(data, json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new GameEditor.ConfigEditor.Model.BuffDiceConfig());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
{   
    renderData.handler = BuffDiceHandler.Create("BuffDiceResult");
}
    BuffDiceHandler.RenderBuffDiceHandler(ref renderData.handler);
}
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}                //GameEditor.ConfigEditor.Model.BuffDiceConfig.RenderBuffDiceConfig(__SelectData);
            }
            GUILayout.EndScrollView();
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        private string GetId(GameEditor.ConfigEditor.Model.BuffDiceConfig data)
        {
            if (data == null)
            {
        ...
        private GameEditor.ConfigEditor.Model.BuffDiceConfig __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
