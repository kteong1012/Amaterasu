...
namespace Game
{
    ...
    public partial class PlayerDataService : GameService
    {
        ...
        {
            var loginService = SSS.Get<LoginService>();
        ...
        public void LoadAll()
        {
            ...
            HotUpdate.NinoGen.Deserializer.Deserialize(data, out List<PlayerData> playerDatas);
        ...
        public void SaveAll()
        {
            ...
            var data = HotUpdate.NinoGen.Serializer.Serialize(playerDatas);
