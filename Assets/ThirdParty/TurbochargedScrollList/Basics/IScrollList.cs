...
namespace Jing.TurbochargedScrollList
{
    ...
    public interface IScrollList
    {
        ...
        /// 渲染列表项
        /// </summary>
        RenderItemDelegate onRenderItem { get; set; }

        /// <summary>
        /// 重构内容的事件
        /// </summary>
        Action onRebuildContent { get; set; }
        ...
        Action<int,object> onSelectItem { get; set; }

        /// <summary>
        /// 当一个列表项被复用时触发
        /// </summary>
        ItemBeforeReuseDelegate onItemBeforeReuse { get; set; }
