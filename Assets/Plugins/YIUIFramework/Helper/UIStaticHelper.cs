...
namespace YIUIFramework
{
    ...
    public static class UIStaticHelper
    {
        ...
        public const string UINamespace = "Game.UI"; //所有生成文件的命名空间
        ...
        public const string UIGenerationPath = "Assets/GameScript/HotUpdate/" + UIProjectName + "/AutoGenerated"; //自动生成的代码

        [LabelText("YIUI项目自定义脚本路径")]
        public const string UICodeScriptsPath = "Assets/GameScript/HotUpdate/" + UIProjectName + "/Logic"; //玩家可编写的核心代码部分
