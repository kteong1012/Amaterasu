    ...
    public class GameServicesGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (var kvp in receiver.serviceTypeNames)
            {
                ...
                sb.AppendLine($"public static bool Is{domain}DomainStarted {{ get; private set; }}");
                ...
                sb.AppendLine($"Is{domain}DomainStarted = true;");
                sb--;
                sb.AppendLine("}");
                ...
                sb.AppendLine($"Is{domain}DomainStarted = false;");
                sb--;
                sb.AppendLine("}");
            }
            ...
            sb.AppendLine("public static void FixedUpdate()");
            sb.AppendLine("{");
            sb++;
            foreach (var kvp in receiver.serviceTypeNames)
            {
                ...
                {
                    var fieldName = "_" + name;
                    sb.AppendLine($"{fieldName}?.FixedUpdate();");
                }
            }
            sb--;
            sb.AppendLine("}");

            sb.AppendLine("public static void LateUpdate()");
            sb.AppendLine("{");
            sb++;
            foreach (var kvp in receiver.serviceTypeNames)
            {
                ...
                {
                    var fieldName = "_" + name;
                    sb.AppendLine($"{fieldName}?.LateUpdate();");
                }
            }
            sb--;
            sb.AppendLine("}");
            ...
            context.AddSourceOrWriteFile("GameServices.g.cs", sb.ToString());
        }
