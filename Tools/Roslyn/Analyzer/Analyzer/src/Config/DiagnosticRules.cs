...
namespace Analyzer.Config
{
    public static class DiagnosticRules
    {
        ...
        public static class DontInvokeRoleDataObjectConstructorRule
        {
            public static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(
                id: DiagnosticIds.DontInvokeRoleDataObjectConstructor,
                title: _title,
                messageFormat: _message,
                category: DiagnosticCategories.Standard,
                defaultSeverity: DiagnosticSeverity.Error,
            ...
            private const string _title = "禁止调用RoleDataObject子类的构造函数";
            private const string _message = "禁止调用 {0} 的构造函数，改为 RoleDataObjectCreator<{0}>.Create().";
            private const string _description = "禁止调用RoleDataObject子类构造函数.";
        }
    }
}